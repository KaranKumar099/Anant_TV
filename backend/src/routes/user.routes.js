...
router
    ...
    .post(jwtVerification, updateAccountDetails);

router
    .route("/update-avatar")
    .patch(jwtVerification, upload.single("avatar"), updateAvatar);
router
    .route("/update-cover-image")
    .patch(jwtVerification, upload.single("coverImage"), updateCoverImage);
