...
function VideoCard({
    ...
    return (
        <div className="main w-sm cursor-pointer">
            <div
                className="relative w-full h-58 overflow-hidden rounded-lg"
            ...
            <div className="mt-3 flex justify-between relative">
                <div className="flex w-full">
                    {owner ? (
                        <div
                            className="w-10 h-10 rounded-full bg-gray-300 flex-shrink-0 overflow-hidden"
                ...
                <button
                    className="cursor-pointer rounded-full h-10 w-11 hover:bg-gray-300 transition-colors duration-500"
                    onClick={handleClick}
                >
                ...
                <div className="absolute left-11/12 top-10 z-10 flex-col items-start bg-gray-300 w-[14rem] rounded-lg overflow-hidden hidden">
                    {buttons ? (
                        <>
                            ...
                            >
                                <button className="cursor-pointer">
                                    <i className="mr-2 ri-edit-line"></i>Edit
                                </button>
                            </div>
                            <div
                                className="w-full py-1 px-3 hover:bg-gray-400 transition-colors duration-300"
                            ...
                            >
                                <button className="cursor-pointer">
                                    <i className="mr-2 ri-delete-bin-6-line"></i>
                                    Delete
                                </button>
                            </div>
                        </>
                        ...
                        <>
                            ...
                            >
                                <button className="cursor-pointer">
                                    <i className="mr-2 ri-play-list-add-line"></i>
                                    Add to playlist
                                </button>
                            </div>
                            <div className="w-full py-1 px-3 hover:bg-gray-400 transition-colors duration-300">
                                <button className="cursor-pointer">
                                    <i className="mr-2 ri-time-line"></i>Save to
                                    Watch later
                                </button>
                            </div>
                            <div className="w-full py-1 px-3 hover:bg-gray-400 transition-colors duration-300">
                                <button className="cursor-pointer">
                                    <i className="mr-2 ri-download-2-line"></i>
                                    Download
                                </button>
                            </div>
                            <div className="w-full py-1 px-3 hover:bg-gray-400 transition-colors duration-300">
                                <button className="cursor-pointer">
                                    <i className="mr-2 ri-share-box-line"></i>
                                    Share
                                </button>
                            </div>
                            <div className="w-full py-1 px-3 hover:bg-gray-400 transition-colors duration-300">
                                <button className="cursor-pointer">
                                    <i className="mr-2 ri-spam-3-line"></i>Not
                                    Interested
                                </button>
                            </div>
                        </>
