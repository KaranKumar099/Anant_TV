    ...
    useEffect(()=>{
        const fetchVideo=async ()=>{
            try {
                ...
                await axios.post(`http://localhost:8000/api/v1/videos/${videoId}/view`,
                  {},
                  {
                      headers:{
                          Authorization: `Bearer ${token}`,
                ...
                await axios.post(`http://localhost:8000/api/v1/watch-history/add`,
                  {videoId},
                  {
                      headers:{
                          Authorization: `Bearer ${token}`,
        ...
        <div className="flex items-center justify-between mt-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">3.79M subscribers</p>
            </div>
          ...
          <div className="flex gap-3">
            <button className="px-4 py-2 bg-gray-200 rounded-full">👍 157K</button>
            <button className="px-4 py-2 bg-gray-200 rounded-full">Share</button>
            <button className="px-4 py-2 bg-gray-200 rounded-full">Download</button>
          </div>
        </div>
