    ...
    <div className='h-full w-full flex-1 flex flex-col items-center'>
        ...
        <form className='flex flex-col gap-4' onSubmit={handleFormSubmit}>
            ...
            <div>
                <h2>Video File</h2>
                <div className='mt-1 flex justify-between items-center'>
                    <input name="videoFile" id='videoFile' type="file" required 
                        className='hidden' onChange={handleVideoFileUpload}/> 
            ...
            <button type="submit" className='p-2 cursor-pointer text-white px-4 py-2 rounded bg-blue-500 transition'>Publish</button>
        </form>
    </div>
  )
}
